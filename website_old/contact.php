...
<h1>Contact</h1> 
<p>You can contact the developers of Schoolsplay in various ways:</p>
<ul>
    <li>Subscribe to the <a href="https://lists.sourceforge.net/lists/listinfo/schoolsplay-devel">mailinglist</a> (This will get you usually the fastest reply!)</li>
    <li>Send a mail to the developers: stas.zytkiewicz@gmail.com or<br>chris.van.bael@gmail.com
    </li>
    <li>If you want to report a bug, you can do so at the <a href="http://sourceforge.net/tracker2/?func=browse&group_id=181294&atid=896620">Schoolsplay bugtracker</a></li>
    <li>If you want to request a feature, please submit it via<br>the <a href="http://sourceforge.net/tracker2/?group_id=181294&atid=896623">Schoolsplay feature requests</a></li>
    </ul>
    <p>
    <b>If you contact us for a problem you encountered, please fill in following template:</b>
    </p>
	<p>
	Platform: (Windows, Linux, OSX)<br>
	Application: (Childsplay, Schoolsplay, Cognitionplay)<br>
	Version:<br>
	Activity:<br>
	Language:<br>
	...
	<p>
	This will save us time and will give you a faster response!

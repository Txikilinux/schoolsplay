...
module_logger = logging.getLogger("schoolsplay.quiz_melody")
...
#TODO: this activity has different names, melody and audio.
# melody is used as name and menu icon.
# audio is used for the content
...
class Activity(quiz.Activity):
  ...
  """
    ...
    def __init__(self,SPGoodies):
        ...
        self.logger =  logging.getLogger("schoolsplay.quiz_melody.Activity")
    ...
    def get_help(self):
        ...
        " ",
        _("At the top of the screen, you will see a question and hear a piece of music."),

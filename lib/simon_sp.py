...
class Activity:
  ...
  """
    ...
    def loop(self,events):
        ...
        # TODO: This should be refactored as it does everything from the eventloop
        # The right way would be to setup the stuff from next_level and only check users
        # events.
        for event in events:
                ...
                if y > 500 : break;
                    ...
                    if self.sequence == self.clicked_colors: 
                        ...
                        if self.throws == self.exercises:
                            ...
                            self.screen.blit(self.backgr_start,(0+15+self.xMargin,0+self.yTop+15))
                            pygame.display.update()
                    elif self.wrong_sequence: #len(self.clicked_colors) == len(self.sequence) and self.clicked_colors!=self.sequence:
    ...
    def check_sequence(self):
        ...
        if self.sequence[:l] != self.clicked_colors[:l]:
            self.logger.debug("wrong sequence entered, setting flag")
